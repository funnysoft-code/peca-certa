...
import { Menu, ScanSearch, Search } from 'lucide-react';
...
const activeItemStyles = 'bg-sidebar-accent text-sidebar-accent-foreground';
    ...
    return (
        <>
            ...
            {breadcrumbs.length > 1 && (
                <div className="w-full border-b border-sidebar-border/70">
