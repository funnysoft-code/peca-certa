    ...
    const modalConfig = useMemo<{
        ...
        if (twoFactorEnabled) {
            return {
                ...
                description:
                    'A autenticação de dois fatores está ativa. Digitalize o código QR ou introduza a chave na aplicação de autenticação.',
                buttonText: 'Fechar',
            };
        }
        ...
        return {
            ...
            description:
                'Para concluir a ativação, digitalize o código QR ou introduza a chave na aplicação de autenticação',
            buttonText: 'Continuar',
        };
