...
final class ListSubGroups implements Tool
{
    ...
    {
        return 'List sub-groups and BOM illustration pages under a main group id (hg). Prefer kind=bom rows for list_bom_parts. Returns ok:false http_error on 4xx/5xx.';
    }
