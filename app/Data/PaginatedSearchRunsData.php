 ...
 */
#[TypeScript]
final readonly class PaginatedSearchRunsData implements JsonSerializable
{
    /**
     * @param  list<SearchRunData>  $data
    ...
    /**
     * @param  LengthAwarePaginator<int, SearchRun>  $paginator
     */
    public static function fromPaginator(LengthAwarePaginator $paginator): self
    {
        /** @var list<SearchRun> $rawItems */
        $rawItems = array_values($paginator->items());

        $items = array_map(
            SearchRunData::fromModel(...),
            $rawItems,
        );
    ...
    /**
     * @return array{data: list<SearchRunData>, links: PaginatorLinks, meta: PaginatorMeta}
     */
